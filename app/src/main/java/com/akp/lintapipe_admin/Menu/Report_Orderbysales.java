...
public class Report_Orderbysales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_orderbysales);
        FindId();
        OnClick();
        LoanrepaymenttApi("");
    }
...
//                    Member_EmpList("","","",username);
    ...
    public void LoanrepaymenttApi(String memberid) {
        String otp1 = new GlobalAppApis().Parm_SAOrderbysales(memberid);
        ApiService client1 = getApiClient_ByPost();
        Call<String> call1 = client1.APIName_SAOrderbysales(otp1);
...
//                    arrRepaymentList.clear();
                    ...
                    if (status.equalsIgnoreCase("true")) { norecord_img.setVisibility(View.GONE);
                        JSONArray jsonArrayr = arrayJSONObject.getJSONArray("Response");
                        for (int i = 0; i < jsonArrayr.length(); i++) {
                            title_tv.setText("Order by sales("+jsonArrayr.length()+")");
                        ...
                        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(Report_Orderbysales.this, 1);
                        adapter = new ReportAdapter(Report_Orderbysales.this, arrRepaymentList);
...
//                        Toast.makeText(Report_Orderbysales.this, "Data Not Found!", Toast.LENGTH_SHORT).show();
                    }} catch (JSONException e) {
                    e.printStackTrace();
                }}
        }, Report_Orderbysales.this, call1, "", true);
    }

    //    Adapter class here added
    public class ReportAdapter extends RecyclerView.Adapter<Report_Orderbysales.ReportAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public Report_Orderbysales.ReportAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_myorder, viewGroup, false);
            Report_Orderbysales.ReportAdapter.VH viewHolder = new Report_Orderbysales.ReportAdapter.VH(view);
            return viewHolder;
        }
        @Override
        public void onBindViewHolder(@NonNull Report_Orderbysales.ReportAdapter.VH vh, int i) {
            ...
            vh.dis_ll.setVisibility(View.GONE);
            vh.pay_ll.setVisibility(View.GONE);
            ...
            vh.view_all_order_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(getApplicationContext(), Report_OrderbysalesByorderId_New.class);
            ...
            vh.invoice_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        Toast.makeText(Report_Orderbysales.this, "Error:- "+e, Toast.LENGTH_LONG).show();
                        e.printStackTrace();  }
                    ...
                    Toast.makeText(Report_Orderbysales.this, "Invoice Download Successfully.,Saved to your Internal Storage", Toast.LENGTH_LONG).show();
                    finish();
                } });
        }
        ...
        public class VH extends RecyclerView.ViewHolder {
            ...
            public VH(@NonNull View itemView) {
                ...
                dis_ll = itemView.findViewById(R.id.dis_ll);
                pay_ll = itemView.findViewById(R.id.pay_ll);
